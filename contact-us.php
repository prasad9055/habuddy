...
<div class="container-fuild p-3" style="background-color:#f4f4f4;">
   <div class="container">
     <div class="row">
        <!-- main content start -->
      <div class="col-md-8" >
      <div style="font-family: Sans-serif ;background-color:rgb(248,249,250);padding:18px;color:black"><br><h2 style="font-family: Sans-serif ;color:black;">Contact Us !</h2>
<h2 style="font-family: Sans-serif ;text-align: center;">Contact To <span id="W_Name1" >Haabuddy</span></h2>
...
<p>if you want to Contact haabuddy team , please drop a mail to <strong> info@haabuddy.com </strong></p>
